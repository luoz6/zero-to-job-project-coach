    ...
    def test_role_templates_reference(self) -> None:
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "时间预算",
                "已有项目或偏好技术栈",
                "评分时结合 github_scoring_matrix.md",
            ],
        )
    ...
    def test_github_scoring_matrix_reference(self) -> None:
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "回退查询",
                "单点深挖",
                "spring boot redis rocketmq docker-compose order system",
                "site:github.com/[开发者]/[仓库名] pom.xml rocketmq",
                "前端",
                "(react OR vue OR vue3) (vite OR next.js) (admin OR dashboard OR saas) permission",
                "site:github.com/[开发者]/[仓库名] package.json prisma",
                "AI 应用开发",
                "(rag OR llm) langchain (milvus OR chroma OR weaviate) chatbot docker",
                "site:github.com/[开发者]/[仓库名] requirements.txt langchain",
                "Go 后端",
                "gin OR hertz",
                "go-zero OR grpc",
                "site:github.com/[开发者]/[仓库名] go.mod redis",
                "DevOps",
                "docker kubernetes prometheus grafana",
                "jenkins",
                "github actions docker-compose deploy monitor",
                "site:github.com/[开发者]/[仓库名] docker-compose.yml prometheus",
                "数据分析",
                "python sql pandas streamlit",
                "jupyter notebook pandas analytics",
                "site:github.com/[开发者]/[仓库名] requirements.txt pandas",
                "移动端开发",
                "android OR ios OR flutter OR react native",
                "sqlite OR realm OR supabase",
                "site:github.com/[开发者]/[仓库名] pubspec.yaml flutter",
                "必须直接套用或拼接以下配方",
                "严禁使用自然语言短句",
                "必须在所有全局搜索末尾携带黑名单词簇",
                "中等体量项目",
                ...
                "下一步建议",
                "必须逐条换行",
                "spring-boot-cache-mq-demo",
                "Spring Boot + Redis + RocketMQ + docker-compose",
                "1 轮定向补充查询",
                "先确认项目的最小启动路径",
                "验证核心接口是否跑通",
                "(react OR vue OR vue3)",
                "(react OR vue) (express OR nest OR fastapi OR gin) fullstack docker-compose",
                "NOT keyword",
            ],
        )
    ...
    def test_job_execution_playbook_reference(self) -> None:
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "1 到 2 周",
                "面试复盘",
                "高压追问需基于 resume_benchmarks.md 的防守清单生成",
            ],
        )
