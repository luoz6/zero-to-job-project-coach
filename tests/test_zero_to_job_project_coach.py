    ...
    def test_github_scoring_matrix_reference(self) -> None:
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "cache OR order OR payment",
                "前端",
                "react admin dashboard permission vite",
                "filename:package.json",
                "table OR form OR workflow",
                "AI 应用开发",
                "rag langchain vector database chatbot",
                "filename:requirements.txt",
                "retrieval OR embedding OR rerank",
